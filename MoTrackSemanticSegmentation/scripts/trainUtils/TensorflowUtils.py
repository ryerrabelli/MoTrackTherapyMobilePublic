...
def conv2d_transpose_strided(x, W, b, output_shape=None, stride = 2, name = None): # Use traspose convolution with stride of 2 to increase image size to output shape if output shape is none double input image shape
    # print x.get_shape()
    # print W.get_shape()
    ...
    if name is None:
        ...
        return tf.nn.bias_add(conv, b, name = name + "_bias")
