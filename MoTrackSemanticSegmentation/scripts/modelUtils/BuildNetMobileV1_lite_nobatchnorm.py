...
#-----------------------------Build network encoder based on MobileNetV1 network and load the trained VGG16 weights-----------------------------------------
       #Layer 1
        ...
        # Layer 2
        self.conv2_1 = self.depthwise_separable_conv2d(self.conv1_1, "conv_ds_2")#Build depthwise separable Convolution layer and load weights
...
######################################Get MobileNet filter ############################################################################################################
    ...
    def depthwise_separable_conv2d(self,bottom,name, stride=1):
        with tf.variable_scope(name):
            # depthwise
