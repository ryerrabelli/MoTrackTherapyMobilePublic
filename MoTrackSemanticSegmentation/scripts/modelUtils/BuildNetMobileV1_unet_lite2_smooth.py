...
##-----------------------Build Net Fully connvolutional layers------------------------------------------------------------------------------------
        ...
        self.upsample_1 = tf.keras.layers.UpSampling2D(4)(self.conv7)
        self._debug(self.upsample_1)
        self.concat_1 = tf.keras.layers.Concatenate()([self.upsample_1,self.conv2_2])
        ...
        self.upsample_2 = tf.keras.layers.UpSampling2D(4)(self.conv8)
        ...
        self.Prob = tf.layers.conv2d(self.upsample_2, 2,3, padding='same', use_bias = False, name = "PRob")
