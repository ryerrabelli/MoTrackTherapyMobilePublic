...
Train_Image_Dir="../data/All/"#"../data/1559216300.3407464/"#Data_Zoo/Materials_In_Vessels/Train_Images/" # Images and labels for training
Train_Label_Dir="../labeled_data/All"#"Data_Zoo/Materials_In_Vessels/LiquidSolidLabels/"# Annotetion in png format for train images and validation images (assume the name of the images and annotation images are the same (but annotation is always png format))
UseValidationSet=False# do you want to use validation set in training
Valid_Image_Dir=None#"../data/1559216300.3407464/"#"Data_Zoo/Materials_In_Vessels/Test_Images_All/"# Validation images that will be used to evaluate training
Valid_Labels_Dir=None#"../labeled_data/1559216300.3407464"#"Data_Zoo/Materials_In_Vessels/LiquidSolidLabels/"#  (the  Labels are in same folder as the training set)
...
MAX_ITERATION = int(1055) # Max  number of training iteration
...
# --------------Save trained model------------------------------------------------------------------------------------------------------------------------------------------
        if itr % 50 == 0 and itr>0:
            ...
            tf.train.write_graph(sess.graph.as_graph_def(), '.', 'logs/tensorflowModel.pbtxt', as_text=True)
